...
- **运行日志**：设置页增加日志 Tab；采集本机关键事件与控制台输出，支持筛选 / 搜索 / 复制 / 清空；对话 / 生图 / 生视频错误写入日志

### 变更

- **提示词优化**：按会话隔离共享状态，避免多会话互相覆盖
- **日志列表**：控制台样式展示，工具栏压缩以扩大可视区域；最新在上并贴顶跟随

### 修复

- **视频预览**：宽屏预览区限制最大高度，避免标题 meta 被顶出首屏
